// frontend/components/survey-builder/canvas/questions/SingleChoiceQuestionView.tsx

"use client";

import * as React from "react";
import type { SingleChoiceQuestion } from "@/lib/survey-builder/types";

type Props = {
  question: SingleChoiceQuestion;
};

export function SingleChoiceQuestionView({ question }: Props) {
